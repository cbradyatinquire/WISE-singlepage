/**
 * Sets the TestTypeNode type as an object of this view
 * 
...
View.prototype.TestTypeNode.generatePage = function(view){
	 ...
	 * 
	 * onkeyup will fire the 'testTypeUpdatePrompt' event which will
	 ...
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('testTypeUpdatePrompt')"});
